...
export const PREGENERATED_JOURNEY: DailyWisdom[] = [
    ...
    {
        day: 1, title: 'LEVEL 30: The First Door', realm: 'Realm of Awakening', xp: 25, breathStyle: 'The Eternal Breath', kazukiWatch: 'Neru, the Whispering Temptation of procrastination.',
        missions: [
    ...
    {
        day: 2, title: 'LEVEL 30: The Body as a Temple', realm: 'Realm of Awakening', xp: 25, breathStyle: 'The Eternal Breath', kazukiWatch: 'Neru thrives on mindless consumption.',
        missions: [
    ...
    {
        day: 3, title: 'LEVEL 31: Clearing the Path', realm: 'Realm of Awakening', xp: 25, breathStyle: 'The Eternal Breath', kazukiWatch: 'The demon of Clutter, Zorga, obscures the path.',
        missions: [
    ...
    {
        day: 4, title: 'LEVEL 31: The Focused Gaze', realm: 'Realm of Awakening', xp: 25, breathStyle: 'The Eternal Breath', kazukiWatch: 'Distraction is Neru\'s favorite tool.',
        missions: [
     ...
     {
        day: 11, title: 'LEVEL 40: The Forge of Will', realm: 'Realm of Discipline', xp: 20, breathStyle: 'The Stone Fortress', kazukiWatch: 'Hesitation is the rust that weakens the will.',
        missions: [
    ...
    {
        day: 21, title: 'LEVEL 50: The Eye of the Storm', realm: 'Realm of Resilience', xp: 18, breathStyle: 'The River of Clarity', kazukiWatch: 'The demon of self-doubt, Malak, whispers in moments of uncertainty.',
        missions: [
    ...
    {
        day: 30, title: 'LEVEL 59: The Cusp of Insight', realm: 'Realm of Resilience', xp: 18, breathStyle: 'The River of Clarity', kazukiWatch: 'Malak will test your resolve before you can truly see within.',
        missions: [
